...
namespace ApiTicketsAzure
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ReposiroryTickets>();
            services.AddDbContext<TicketsContext>(options => options.UseSqlServer(cadena));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ApiTicketsAzure", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiTicketsAzure v1");
                c.RoutePrefix = "";
            });
